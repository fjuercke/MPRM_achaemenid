...
var slp_pct = slp_rad.tan().multiply(100);  // **changed: now slope in percent**
...
var critical = 8;  // ŝ value (critical slope)

// Calculate slope cost: Cost(s) = 1 + (s/ŝ)^2
var cost_slope = slp_pct.divide(critical).pow(2).add(1);  // **replaced Herzog polynomial**
